...
public class Sub_catgory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<Product_attrubuts> personNames;
    Context context;
    public Sub_catgory(Context context, ArrayList<Product_attrubuts> personNames) {
